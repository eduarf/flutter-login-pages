    ...
    return Column(
      ...
      children: [
        Text(
          ...
          style: AppTextStyles().normalStyle.copyWith(color: Colors.black87),
        ),
        SizedBox(
      ...
      child: Column(
        ...
        children: [
          Text(
            AppStrings().login,
            style:
                AppTextStyles().bigTitle.copyWith(color: AppTwoColors().white),
          ),
          Padding(
            padding: AppTwoPaddings().horizontal25,
            child: InputWidget(
              hintText: AppStrings().hintTextMail,
              prefixIcon: Icon(
                Icons.email,
                color: AppTwoColors().white,
              ),
            ),
          ),
          Padding(
            ...
            child: InputWidget(
                ...
                obscureText: true,
                prefixIcon: Icon(Icons.lock, color: AppTwoColors().white)),
          ),
          Button(
